...
import ConsumoView from './components/ConsumoView.jsx';
...
function Topbar({ view, user, collapsed }) {
  const VIEW_LABELS = {
    ...
    'ot-dashboard': 'Dashboard OT',
    asignacion: 'Entrega a Técnico',
    devolucion: 'Devolución',
    consumo: 'Consumo',
    'reasignacion-ot': 'Reasignar OT',
    movimientos: 'Movimientos',
    reasignaciones: 'Historial Reasignaciones',
    bodegas: 'Bodegas',
    ot: 'Órdenes de Trabajo',
    'carga-masiva': 'Carga Masiva',
    'control-calidad': 'Control de Calidad QA',
  ...
  const loadAll = useCallback(async () => {
    ...
    try {
      ...
      if (i.status === 'fulfilled') {
        setInv(Array.isArray(i.value?.data) ? i.value.data : Array.isArray(i.value) ? i.value : []);
      }
